...
for (let usersListElement of usersList) {
    ...
    document.write(`<p>City - ${usersListElement.address.city}</p><p>Street - ${usersListElement.address.street}</p>`);
    document.write(`<p>Suite - ${usersListElement.address.suite}</p><p>Zip code - ${usersListElement.address.zipcode}</p>`);
